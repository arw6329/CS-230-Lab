    ...
    <div class="my-auto">
        <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <img src="/images/c2.jpg" alt="Profile Picture" onclick="triggered();" id="gallery-display">
            ...
            <div class="form-group">
                <textarea name="descript" id="file" cols="30" rows="10" placeholder="Description" style="text-align:center"></textarea>
            </div>
            <div class="form-group">
